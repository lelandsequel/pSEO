...
# 2. Define Columns (Template + Action)
# The user's template didn't have 'Action', but the error requires it. 
# We'll add it as the first column.
template_columns = [
...
# Prepend 'Action' to the column list
final_columns = ['Action'] + template_columns

# 3. Generate Data (150 Pins)
data = []
...
# 5. Export
df_final.to_csv('pinterest_bulk_upload_v3.csv', index=False)
print("✅ Created 'pinterest_bulk_upload_v3.csv' with Action column.")
