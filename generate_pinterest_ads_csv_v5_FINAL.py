...
# 2. Define the Columns (Action FIRST + Template Columns)
# We strictly define the order here to satisfy Pinterest.
columns = [
...
# CRITICAL: Set Action to CREATE for every row
...
# 5. Export
output_file = 'pinterest_bulk_upload_v5_FINAL.csv'
df_final.to_csv(output_file, index=False)

print(f"✅ Created {output_file}")
print("\n📊 PREVIEW of First 3 Rows:")
print(df_final[['Action', 'Campaign Name', 'Ad Group Name', 'Pin Title']].head(3))
print(f"\n📈 Total Pins: {len(df_final)}")
print(f"📋 Total Columns: {len(columns)}")
print(f"📅 Start Date: {today}")
print(f"💰 Daily Budget: $10.00")
print("\n🎯 Ready for Pinterest Ads Manager upload!")
